...
set BENCH_FILE=evaluation\results\benchmark_results.json
if exist "%BENCH_FILE%" (
    echo   OK : %BENCH_FILE%
) else (
...
set ROB_FILE=evaluation\results\robustness_results.json
if exist "%ROB_FILE%" (
    echo   OK : %ROB_FILE%
) else (
...
echo Resultats :
echo   evaluation\results\benchmark_results.json
echo   evaluation\results\robustness_results.json
echo ============================================================
echo.
