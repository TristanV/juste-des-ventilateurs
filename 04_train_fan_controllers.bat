...
python -m evaluation.fan_control_eval --label %LABEL% --models all --output evaluation\results\fan_control_results_%LABEL%.json
set _RC=%ERRORLEVEL%
...
set RESULTS_FILE=evaluation\results\fan_control_results_%LABEL%.json
...
echo Resultats : evaluation\results\fan_control_results_%LABEL%.json
echo ============================================================
exit /b 0
